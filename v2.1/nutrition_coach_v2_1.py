"""
NutritionGPT Coach v2.1 - Enhanced Memory & Human-like Conversation
Built with LangChain, ChromaDB vector memory, and improved AI personality
"""
...
class EnhancedMemoryManager:
    """Manages vector-based memory with ChromaDB"""
    ...
    def _initialize_vector_store(self):
        ...
        try:
            # Create a simple in-memory ChromaDB (for Lambda compatibility)
            self.vector_store = Chroma(
                embedding_function=self.embeddings,
                collection_name="nutrition_memories"
            )
    ...
    def store_memory(self, user_id: str, message: str, response: str, memory_type: str = "general", metadata: Dict = None):
        """Store a conversation memory in vector DB"""
...
class NutritionCoachV2_1:
    def __init__(self, openai_api_key: str, telegram_token: str):
        ...
        self.memory_manager = EnhancedMemoryManager(openai_api_key)
